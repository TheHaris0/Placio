          ...
          <div className=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul className="navbar-nav ms-auto ">
              ...
              {/* <li className="nav-item dropdown">
                <a className="nav-link mx-2 dropdown-toggle" href="/" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ color: '#000000', fontWeight:'500' }}>
                  More
                </a>
                <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <li><a className="dropdown-item" href="/" style={{ color: '#000000', fontWeight:'500' }}>Contact us</a></li>
                  <li><a className="dropdown-item" href="/" style={{ color: '#000000', fontWeight:'500' }}>About Us</a></li>
                </ul>
              </li> */}
              <li className="nav-item">
                <button
